...
public class Ex1 extends MainTestClass {
    ...
    public void checkWebPageContent() {
        ...
        softAssert.assertEquals(homePage.getIndexTextElementListContent(), expectedIndexText,
        ...
        softAssert.assertEquals(homePage.getLeftSectionMenuListSize(), 5,
        ...
        softAssert.assertEquals(homePage.getLeftSectionMenuListContent(), expectedMenuContentText,
